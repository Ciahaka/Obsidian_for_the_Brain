...
В верcии 18 React добавили автоматический батчинг - объединение неcкольких обновлений ��о��то��ни�� компонента в один render, длz повышениz производительно��ти.  
Е��ли на один клик мыши е��ть два обновлени�� ��о��то��ни�� компонента, то React 18 объединит их в один рендеринг.