...
Это алгоритм сравнения виртуальных домов в React при изменении состояни�� компонента.
#### render  
Это функци�� котора�� ��оздаёт дерево React ��лементов. При изменении ��о��то��ни��, render ��оздаёт новое дерево.
### Батчинг  
[Hubr](https://habr.com/ru/post/577168/#2)  
[Github](https://github.com/reactwg/react-18/discussions/21)  
В верcии 18 React добавили автоматический батчинг - объединение неcкольких обновлений ��о��то��ни�� компонента в один render, для повышения производительности.  
Если на один клик мыши есть два обновления то��то��ни�� компонента, то React 18 объединит их в один рендеринг.