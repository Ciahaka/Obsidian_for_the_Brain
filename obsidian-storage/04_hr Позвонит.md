...
Функция, которая оборачивает оригинальный компонент в компонент (контейнер). Оригинальный компонент получает все пропсы переданные контейнеру
Можно сказать иначе - принимает компонент и возвращает новый компонент).
