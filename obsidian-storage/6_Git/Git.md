...
В папке SHH появятся новые ключи. Публичный ключ (расширение .pub) копируем и идём привязывать к своему новому аккаунту. Настройки --> SSH and GPG -->New SSH keys
