...
Для того, чтобы после работы с формой редактирования title элемента, при клике на поле вне элемента, input исчезал, а исходный элемент возвращался - нужно повесть на input обработчик onBlur. В него помести функцию Handler. Её логику вынеси наверх, а в теле
