...
Второй вариант, это поместить все таски в ассоциативный массив, в котором ключами будут выступать общие id для туду и тасок (вернее значения id, а не сама переменная id.). А значениями этих ключей будут массивы тасок. Таким образом, обращаясь по id к туду, одновременно сможешь, по этому же id, достучаться и до соответствую
