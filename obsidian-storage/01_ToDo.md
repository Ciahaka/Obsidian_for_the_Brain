...
Задача UI: Сделать так, чтобы при двойном клике на элемент DOM, содержащий title, этот элемент преобразовывался в input элемент. Появлялась возможность редактирования title. Новое значение сохранялось. А при снятии фокуса с элемента, inpu

### Универсальная форма изменения title
Задача: Сделать так, чтобы при двойном клике
