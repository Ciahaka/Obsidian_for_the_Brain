...
В обработчик помести функцию Handler, саму функцию вынеси наверх, и в её логике вызови функцию перерисовки стейта(setState), и в её вызов помести true. Тем самым переписывая 
