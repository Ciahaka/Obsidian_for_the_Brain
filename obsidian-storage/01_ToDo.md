...
Далее создай отдельный компонент для универсальной формы ввода. В его return перемести div с инпутом и кнопкой из верхнего компонента(туду). Так же перемести всю функции отвечающие за добавление, удаление.... и прочие, связанные с логикой инпута. Так же перемещай оба стейта( отвечающих за хранение  )
