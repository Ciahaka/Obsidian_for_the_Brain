...
Сейчас возник конфликт с передачей коллбэка (addTask) добавления таски. Для его решения создаём функцию обёртку над return. Обзывай её addTask, входным параметром будет title нового туду. В теле функции вызывай приходящую в пропсах фукцию добавления таски, и в её вызов помещай
