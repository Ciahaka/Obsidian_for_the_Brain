...
Такое решение помогает использовать один колбэк для передачи  в компоненты с разным набором атрибутов. ^f2b784
 ...
 Ты засетал новый массив, но тасок для него нет. Поэтому вызывай функцию setState тасок и в её вызове создай литерал объекта, помещай в него копию старых тасок, 
