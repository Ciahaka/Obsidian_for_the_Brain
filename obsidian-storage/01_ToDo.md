...
Для того, чтобы сохранить возможность фильтрации тасок по состоянию, нужно всю логику фильтрации запихнуть в map, разместив её над return.
...
Теперь в условии if  можно сказать, что если значение свойства filter, взятое у элемента промапленного стейта туду строго равно одному из значений фильтра? nj
