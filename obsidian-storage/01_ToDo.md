...
[Функция обёртка для колбэка добавления таски](#)
...
Такое решение помогает использовать один колбэк для передачи  в компоненты с разным набором атрибутов.
