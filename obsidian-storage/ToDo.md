...
В теле функции изменения состояния фильтра пробегаем методом fined по стейту тудулистов и находим элемент id которого строго равен id тудулиста пришедшего в параметрах функции. Если такой элемент найден, то его свойству filter
