...
В BLL, в функцию изменения состояния фильтра добавь ещё один входной параметр -  id тудулиста, протипизируй его. В дочерней компоненте поправь типизацию функции. И в Handler функциях кнопок изменения статуса
