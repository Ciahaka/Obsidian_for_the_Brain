...
На данном этапе, значение фильтра мы уже берём не из локального стейта фильтра, а напрямую из стейта тудулистов, поэтому можно стейт фильтра сносить, а в атрибуте фильтра указать, что берём его у элемента промапенного стейта
![[Pasted image 20230331160839.png]]
