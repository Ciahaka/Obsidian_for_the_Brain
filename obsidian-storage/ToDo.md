...
В теле создаём переменную и присваиваем ей сгенерированную на коленке таску (copy/paste)/
Создаём ещё одну переменную и присваиваем ей новый массив, в который сначала помещаем 
7:48 - про key
