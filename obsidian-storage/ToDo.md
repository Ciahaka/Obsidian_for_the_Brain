...
Со старта считаем, что ошибки нет и стартовым значением указываем null. Обязательно типизируем стейт дженериками, в которых прописываем, что стейт может быть 
