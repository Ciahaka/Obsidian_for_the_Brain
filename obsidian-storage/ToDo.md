...
В колбэк onChange помещаем событие интерфеса event, типизируем его как `e:ChangeEvent<HTMLInputElement>`, а в теле колбэка вызываем функцию setState и в её вызове привязываем наш инпут к событию onChange
