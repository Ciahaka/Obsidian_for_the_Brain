...
В BLL компоненте создаём функцию меняющую состояние фильтра. Во входящих параметрах она принимает возможное value тип который будет ранее созданный. В теле функции вызы
Вешаем обработчики события onClick на кнопки фильтрации состояния тасок. 
