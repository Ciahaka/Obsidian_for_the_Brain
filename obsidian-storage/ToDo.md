...
Далее на каждую кнопку фильтра вешаем атрибут className и внутри, тернарным оператором, прописываем условие: что если, пришедший в пропсах стейт будет срого 
